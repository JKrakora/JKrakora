...
- multiplayer.gd, as it's an autoload.
- level.gd, though I recommend extending it when level/map-specific code is needed
- game.gd, except for the _spawn_function, which can be customized as needed.
- spawn_point.gd
- Game.tscn
